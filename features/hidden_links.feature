...
As the system
I want to hide links form users who can't act on them
...
Background:
  ...
  Scenario: New project link is hidden fron non-signed in users
  ...
  Scenario: New ticket linkk is hidden from a user without permission
    Given I am signed in as "user@ticketee.com"
    When I follow "TextMate 2"
  ...
  Scenario: Delete ticket link is shown to a user with permission
    Given "user@ticketee.com" can delete tickets in the "TextMate 2" project
    And I am signed in as "user@ticketee.com" 
    When I follow "TextMate 2"
    And I follow "Shiny!"
    Then I should see "Delete Ticket"
  
  Scenario: Delete ticket link is hedden form a user without permission
    Given I am signed in as "user@ticketee.com"
    When I follow "TextMate 2"
    And I follow "Shiny!"
    Then I should not see the "Delete Ticket" link
    
  Scenario: Delete ticke link is shown to admins
    Given I am signed in as "admin@ticketee.com"
    When I follow "TextMate 2"
    And I follow "Shiny!"
